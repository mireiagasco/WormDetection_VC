...
In this case, the worms that are in the well-lit area are clearly seen, while those that are in the dark area are detected as background and their information is lost. 
It should also be said that this situation varies greatly between images.  In this case the problem is very obvious due to the lighting of this image, but if we take another one with more homogeneous lighting, we can get much better results:
